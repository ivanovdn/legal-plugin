...
[`docs/using-the-assistant.md`](using-the-assistant.md), the *"Telling us what
it got wrong"* section — hand testers that, not this. (It was split out of
`tester-setup.md`, which is now install steps only.)
