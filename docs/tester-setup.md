...
Then **everybody** does [Step 6](#step-6-everyone--put-your-name-in) — that's
the last step.
...
This is how your work is attributed on our side — there's no company login in
the assistant yet, so it can't work this out for itself. Please don't skip it.
...
playbook, and it is wrong often enough to be worth checking. **Using it day to
day — what the three tabs do, and how to tell us when it's wrong — is a separate
short guide**, sent alongside this one.
...
*This guide covers installation only.* Using the assistant — what the three tabs
do, and how to report what it got wrong — is a separate document,
[`docs/using-the-assistant.md`](using-the-assistant.md).
